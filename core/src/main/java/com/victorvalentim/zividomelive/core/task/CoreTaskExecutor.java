...
/** Process-wide bounded daemon pool hidden behind {@link TaskGroup}. */
final class CoreTaskExecutor {
    ...
    private static final ThreadFactory THREAD_FACTORY = runnable -> {
        Thread thread = new Thread(
                runnable,
                "zividomelive-core-task-" + THREAD_SEQUENCE.incrementAndGet());
