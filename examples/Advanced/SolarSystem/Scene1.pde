...
class Scene1 implements Scene {
  ...
  private SceneCameraService sceneCamera;
  ...
  private void initializeSceneResources() {
    ...
    sceneCamera.setInputEnabled(true);
    sceneCamera.trackTarget(this::resolveCameraTarget);
  ...
  private void promptForDate() {
    ...
    try {
      ...
      resetBodiesToJ2000();
      propagateFromJ2000(clock.getDaysSinceJ2000(), false);
  ...
  private void resetView() {
    ...
    sceneCamera.snapToAxisAngle(0, 0, 0, 1, 0, 0, PI / 16f, distance);
  }
