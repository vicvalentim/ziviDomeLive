...
import com.victorvalentim.zividomelive.internal.performance.GpuTimerQualification;
 ...
 */
public final class ProcessingGpuMeasurementSession implements AutoCloseable {
    private enum Phase {
        UNINITIALIZED,
        QUALIFYING_TIMER,
        TIMER,
