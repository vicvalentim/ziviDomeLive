...
| 360-degree spherical reference | Resolution-matched, unmodified Paul Bourke v14 equirectangular patterns, `+Z` north pole, `-Z` south pole, longitude seam, and 60-second frame-stepped rotation | Not executed |
...
13. Run the 60-second rotation at both 30 fps/1800 frames and 60 fps/3600 frames; inspect line shimmer, cadence, texture seams, and blend zones.
