...
| 360-degree spherical reference | Unmodified Paul Bourke v14 equirectangular pattern, `+X` north pole, `-X` south pole, longitude seam, and 60-second rotation | Not executed |
...
10. Switch to Scene 2 and confirm the Paul Bourke sphere places its north pole at `+X`, south pole at `-X`, and equator on `X=0`.
