...
- **GPU visual:** [CalibrationTool](../qualification/calibration-tool.md) e cenas representativas em OpenGL real.
- **Benchmark:** [BenchmarkTool](../qualification/benchmark-guide.md) nos modos suportados.
